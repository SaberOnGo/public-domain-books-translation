...
在已完成《爱迪生征服火星》出版级术语、标题和长段落精修的基础上，补齐与 `pg20923_a_negro_explorer_at_the_north_pole`、`pg10966_the_ghost_pirates` 同级的栅格封面产物，并再次复核书籍首页信息、译者署名、EPUB 内封面引用、重点段落文学性和全书“信达雅”闭环。

## 执行边界

- 书籍目录：`books/pg19141_edisons_conquest_of_mars/`
...
- `pg20923_a_negro_explorer_at_the_north_pole`：保留高清源图，EPUB 内使用压缩 JPG；封面页和 OPF `cover-image` 必须存在。
- `pg10966_the_ghost_pirates`：封面必须与本书情节一致，书籍信息页要包含 `LifeBook 书坊 + 个人名`、译制时间、公版来源 URL、公版说明。
