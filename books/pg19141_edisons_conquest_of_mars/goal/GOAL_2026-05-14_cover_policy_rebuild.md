...
按 `template/epub_pipeline/common/references/cover_design_policy.md` 与 `book_info_frontmatter_policy.md`，以及本轮补充的封面文字规则，重新制作 `pg19141_edisons_conquest_of_mars` 的封面和书籍信息页，并重新生成 EPUB。
