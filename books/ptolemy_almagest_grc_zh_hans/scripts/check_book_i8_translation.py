...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "008_book_i_08_translation_check.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "008_book_i_08_translation_check.md"
...
REQUIRED = [
    ...
    },
    {
        ...
        "path": "qa/chapter_controls/008_book_i_08_two_primary_motions.control.md",
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.8 translation check passed; review remains pending")
    return 0
