...
TRANSLATION = PROJECT_ROOT / "chapters" / "translated" / "008_book_i_08_two_primary_motions.md"
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "008_book_i_08_post_translation_technical_recheck.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "008_book_i_08_post_translation_technical_recheck.md"


REQUIRED = [
    {
        "id": "post_translation_recheck_exists",
        "path": "qa/technical/008_book_i_08_two_primary_motions.post_translation_technical_recheck.md",
        "contains": [
    ...
    },
    {
        ...
        "path": "chapters/translated/008_book_i_08_two_primary_motions.md",
        "contains": [
            "CONTROLLED_DRAFT_TRANSLATION__REVIEW_PENDING",
            "本章译文依据 `chapters/src/008_book_i_08_two_primary_motions.md`",
    ...
    {
        "id": "review_exists",
        "path": "reviews/chapters/008_book_i_08_two_primary_motions.review.md",
        "contains": [
    ...
    {
        "id": "term_lock_contains_book_i8_terms",
...
def collect_checks() -> tuple[list[dict[str, object]], list[str]]:
    ...
    if marker_hits:
        failures.append(f"Book I.8 body contains unexpected geometry/table/numeric markers: {marker_hits}")
    checks.append({"id": "geometry_table_numeric_markers_absent_for_i8", "status": "PASS" if not marker_hits else "FAIL", "hits": marker_hits})
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.8 post-translation technical recheck passed; chapter quality gate remains pending")
    return 0
