...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "009_book_i_09_formal_source_recheck.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "009_book_i_09_formal_source_recheck.md"
...
REQUIRED = [
    {
        ...
        "contains": [
            ...
            "Greek_title | θʹ. Περὶ τῶν κατὰ μέρος καταλήψεων.",
            "estimated_pdf_viewer_pages | `19`",
            "Use English translations only as reference witnesses",
        ],
    },
    {
        "id": "source_extraction_check_exists",
        "path": "qa/pretranslation/009_book_i_09_source_extraction_check.md",
        "contains": ["PASS_SOURCE_EXTRACTED__PDF_RECHECK_AND_TECHNICAL_QA_PENDING"],
    },
    {
        "id": "pdf_contact_sheet_exists",
        "path": "qa/technical/page_screenshots/book_i09_page_019_contact_sheet.jpg",
        "contains": [],
    },
    {
        "id": "technical_audit_exists",
        "path": "qa/technical/009_book_i_09_on_individual_preliminaries.technical_audit.md",
        "contains": [
    ...
    },
    {
        ...
        "contains": [
            "Book I.9 具体测定与弦论引入术语",
            "κατὰ μέρος καταλήψεις",
            "ὁλοσχερὴς προδιάληψις",
            "κατὰ μέρος ἀποδείξεις",
            "πηλικότης τῶν ἐν τῷ κύκλῳ εὐθειῶν",
            "γραμμικῶς ἀποδεικνύειν",
        ],
    },
]

FORBIDDEN = [
    "chapters/final/009_book_i_09_on_individual_preliminaries.md",
    "output/book.epub",
]
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.9 formal source recheck passed; chapter control remains pending")
    return 0
