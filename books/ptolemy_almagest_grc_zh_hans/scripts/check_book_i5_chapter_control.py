...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "005_book_i_05_chapter_control_check.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "005_book_i_05_chapter_control_check.md"
...
REQUIRED = [
    ...
    },
    {
        ...
        "path": "qa/pretranslation/005_book_i_05_formal_source_recheck.md",
        ...
        json.dumps(
            {
                ...
                "chapter": "Book I.5",
                "translation_file_allowed_next": "chapters/translated/005_book_i_05_earth_is_central.md"
                if not failures
                else "",
                "final_allowed": False,
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.5 chapter control check passed; controlled translation prep is allowed")
    return 0
