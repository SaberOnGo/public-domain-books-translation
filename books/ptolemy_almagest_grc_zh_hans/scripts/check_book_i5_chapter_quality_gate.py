...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "005_book_i_05_chapter_quality_gate.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "005_book_i_05_chapter_quality_gate.md"
...
REQUIRED_MARKDOWN = [
    {
        ...
        "path": "qa/chapter_controls/005_book_i_05_earth_is_central.quality_gate.md",
        "contains": [
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.5 chapter quality gate passed; final promotion remains pending")
    return 0
