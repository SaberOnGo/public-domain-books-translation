...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "002_book_i_02_translation_check.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "002_book_i_02_translation_check.md"
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.2 translation check passed; review remains pending")
    return 0
