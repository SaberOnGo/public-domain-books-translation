...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "006_book_i_06_chapter_quality_gate.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "006_book_i_06_chapter_quality_gate.md"
...
REQUIRED_MARKDOWN = [
    {
        ...
        "path": "qa/chapter_controls/006_book_i_06_earth_as_point_to_heavens.quality_gate.md",
        "contains": [
            "PASS_CHAPTER_QUALITY_GATE__FINAL_PROMOTION_PENDING",
            "不允许写 `chapters/final/006_book_i_06_earth_as_point_to_heavens.md`",
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.6 chapter quality gate passed; final promotion remains pending")
    return 0
