...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "006_book_i_06_chapter_control_check.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "006_book_i_06_chapter_control_check.md"
...
REQUIRED = [
    ...
    },
    {
        ...
        "path": "qa/pretranslation/006_book_i_06_formal_source_recheck.md",
        ...
        json.dumps(
            {
                ...
                "chapter": "Book I.6",
                "translation_file_allowed_next": "chapters/translated/006_book_i_06_earth_as_point_to_heavens.md"
                if not failures
                else "",
                "final_allowed": False,
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.6 chapter control check passed; controlled translation prep is allowed")
    return 0
