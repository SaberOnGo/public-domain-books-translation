...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "003_book_i_03_chapter_quality_gate.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "003_book_i_03_chapter_quality_gate.md"
...
REQUIRED_MARKDOWN = [
    {
        ...
        "path": "qa/chapter_controls/003_book_i_03_heaven_moves_spherically.quality_gate.md",
        "contains": [
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.3 chapter quality gate passed; final promotion remains pending")
    return 0
