...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "004_book_i_04_formal_source_recheck.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "004_book_i_04_formal_source_recheck.md"
...
REQUIRED = [
    ...
    },
    {
        ...
        "path": "qa/pretranslation/004_book_i_04_source_extraction_check.md",
        "contains": ["PASS_SOURCE_EXTRACTED__PDF_RECHECK_AND_TECHNICAL_QA_PENDING"],
    },
    {
        "id": "pdf_contact_sheet_exists",
        "path": "qa/technical/page_screenshots/book_i04_pages_011_012_contact_sheet.jpg",
        "contains": [],
    },
    {
        "id": "technical_audit_exists",
        "path": "qa/technical/004_book_i_04_earth_is_spherical.technical_audit.md",
        "contains": [
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.4 formal source recheck passed; chapter control remains pending")
    return 0
