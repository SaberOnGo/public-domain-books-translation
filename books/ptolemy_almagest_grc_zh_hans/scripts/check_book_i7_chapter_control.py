...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "007_book_i_07_chapter_control_check.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "007_book_i_07_chapter_control_check.md"
...
REQUIRED = [
    ...
    },
    {
        ...
        "path": "qa/pretranslation/007_book_i_07_formal_source_recheck.md",
        ...
        json.dumps(
            {
                ...
                "chapter": "Book I.7",
                "translation_file_allowed_next": "chapters/translated/007_book_i_07_earth_has_no_translational_motion.md"
                if not failures
                else "",
                "final_allowed": False,
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.7 chapter control check passed; controlled translation prep is allowed")
    return 0
