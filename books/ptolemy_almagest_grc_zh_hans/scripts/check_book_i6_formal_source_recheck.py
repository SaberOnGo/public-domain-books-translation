...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "006_book_i_06_formal_source_recheck.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "006_book_i_06_formal_source_recheck.md"
...
REQUIRED = [
    {
        ...
        "contains": [
            ...
            "Greek_title | ϛʹ. Ὅτι σημείου λόγον ἔχει πρὸς τὰ οὐράνια ἡ γῆ.",
            "estimated_pdf_viewer_pages | `14`",
            "Use English translations only as reference witnesses",
        ],
    },
    {
        "id": "source_extraction_check_exists",
        "path": "qa/pretranslation/006_book_i_06_source_extraction_check.md",
        "contains": ["PASS_SOURCE_EXTRACTED__PDF_RECHECK_AND_TECHNICAL_QA_PENDING"],
    },
    {
        "id": "pdf_contact_sheet_exists",
        "path": "qa/technical/page_screenshots/book_i06_page_014_contact_sheet.jpg",
        "contains": [],
    },
    {
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.6 formal source recheck passed; chapter control remains pending")
    return 0
