...
CONTROL = PROJECT_ROOT / "qa" / "chapter_controls" / "001_book_i_01_proem.control.md"
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "001_book_i_01_chapter_control_check.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "001_book_i_01_chapter_control_check.md"
...
REQUIRED = [
    ...
    },
    {
        ...
        "path": "qa/pretranslation/001_book_i_01_formal_source_recheck.md",
        ...
        json.dumps(
            {
                ...
                "chapter": "Book I.1",
                "translation_file_allowed_next": "chapters/translated/001_book_i_01_proem.md" if not failures else "",
                "final_allowed": False,
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.1 chapter control check passed; controlled translation prep is allowed")
    return 0
