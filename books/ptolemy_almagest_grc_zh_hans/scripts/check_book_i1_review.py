...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "001_book_i_01_review_check.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "001_book_i_01_review_check.md"
...
REQUIRED = [
    {
        ...
        "contains": [
            ...
            "神学性研究",
            "自然学",
            "不允许写 `chapters/final/001_book_i_01_proem.md`",
        ],
    },
    {
        "id": "translation_check_exists",
        "path": "qa/pretranslation/001_book_i_01_translation_check.md",
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.1 review check passed; technical recheck remains pending")
    return 0
