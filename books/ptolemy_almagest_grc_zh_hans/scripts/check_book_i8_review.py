...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "008_book_i_08_review_check.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "008_book_i_08_review_check.md"
...
REQUIRED = [
    ...
    },
    {
        ...
        "path": "qa/pretranslation/008_book_i_08_translation_check.md",
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.8 review check passed; technical recheck remains pending")
    return 0
