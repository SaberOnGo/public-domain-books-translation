...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "001_book_i_01_chapter_quality_gate.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "001_book_i_01_chapter_quality_gate.md"
...
REQUIRED_MARKDOWN = [
    {
        ...
        "path": "qa/chapter_controls/001_book_i_01_proem.quality_gate.md",
        "contains": [
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.1 chapter quality gate passed; final promotion remains pending")
    return 0
