...
TRANSLATION = PROJECT_ROOT / "chapters" / "translated" / "002_book_i_02_order_of_the_theorems.md"
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "002_book_i_02_post_translation_technical_recheck.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "002_book_i_02_post_translation_technical_recheck.md"


REQUIRED = [
    {
        "id": "post_translation_recheck_exists",
        "path": "qa/technical/002_book_i_02_order_of_the_theorems.post_translation_technical_recheck.md",
        "contains": [
    ...
    },
    {
        ...
        "contains": [
            ...
            "本章译文依据 `chapters/src/002_book_i_02_order_of_the_theorems.md`",
    ...
    {
        "id": "review_exists",
        "path": "reviews/chapters/002_book_i_02_order_of_the_theorems.review.md",
        "contains": [
    ...
    {
        "id": "term_lock_contains_book_i2_terms",
...
def collect_checks() -> tuple[list[dict[str, object]], list[str]]:
    ...
    if topic_hits:
        failures.append(f"Book I.2 body contains unexpected geometry/table/numeric markers: {topic_hits}")
    checks.append({"id": "geometry_table_numeric_markers_absent_for_i2", "status": "PASS" if not topic_hits else "FAIL", "hits": topic_hits})
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.2 post-translation technical recheck passed; chapter quality gate remains pending")
    return 0
