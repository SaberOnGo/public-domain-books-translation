...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "006_book_i_06_review_check.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "006_book_i_06_review_check.md"
...
REQUIRED = [
    ...
    },
    {
        ...
        "path": "qa/pretranslation/006_book_i_06_translation_check.md",
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.6 review check passed; technical recheck remains pending")
    return 0
