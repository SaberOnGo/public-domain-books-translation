...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "008_book_i_08_chapter_control_check.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "008_book_i_08_chapter_control_check.md"
...
REQUIRED = [
    ...
    },
    {
        ...
        "path": "qa/pretranslation/008_book_i_08_formal_source_recheck.md",
        ...
        json.dumps(
            {
                ...
                "chapter": "Book I.8",
                "translation_file_allowed_next": "chapters/translated/008_book_i_08_two_primary_motions.md"
                if not failures
                else "",
                "final_allowed": False,
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.8 chapter control check passed; controlled translation prep is allowed")
    return 0
