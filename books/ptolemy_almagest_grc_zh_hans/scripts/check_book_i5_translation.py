...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "005_book_i_05_translation_check.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "005_book_i_05_translation_check.md"
...
REQUIRED = [
    ...
    },
    {
        ...
        "path": "qa/chapter_controls/005_book_i_05_earth_is_central.control.md",
        "contains": ["PASS_FOR_CONTROLLED_TRANSLATION_PREP__NOT_TRANSLATED"],
    },
    {
        "id": "technical_audit_exists",
        "path": "qa/technical/005_book_i_05_earth_is_central.technical_audit.md",
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.5 translation check passed; review remains pending")
    return 0
