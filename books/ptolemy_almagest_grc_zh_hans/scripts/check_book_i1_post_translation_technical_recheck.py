...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "001_book_i_01_post_translation_technical_recheck.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "001_book_i_01_post_translation_technical_recheck.md"


REQUIRED = [
    {
        "id": "post_translation_recheck_exists",
        "path": "qa/technical/001_book_i_01_proem.post_translation_technical_recheck.md",
        "contains": [
    ...
    },
    {
        ...
        "contains": [
            ...
            "本章译文依据 `chapters/src/001_book_i_01_proem.md`",
    ...
    {
        "id": "review_exists",
        "path": "reviews/chapters/001_book_i_01_proem.review.md",
        "contains": [
    ...
    {
        "id": "term_lock_contains_book_i1_terms",
...
def collect_checks() -> tuple[list[dict[str, object]], list[str]]:
    ...
    checks.append(
        {
            "id": "translation_body_modernizing_terms_absent",
    ...
    if topic_hits:
        failures.append(f"Book I.1 body contains unexpected geometry/table/numeric markers: {topic_hits}")
    checks.append(
        {
            "id": "geometry_table_numeric_markers_absent_for_i1",
            "status": "PASS" if not topic_hits else "FAIL",
            "hits": topic_hits,
        }
    )
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.1 post-translation technical recheck passed; chapter quality gate remains pending")
    return 0
