...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "003_book_i_03_chapter_control_check.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "003_book_i_03_chapter_control_check.md"
...
REQUIRED = [
    ...
    },
    {
        ...
        "path": "qa/pretranslation/003_book_i_03_formal_source_recheck.md",
        ...
        json.dumps(
            {
                ...
                "chapter": "Book I.3",
                "translation_file_allowed_next": "chapters/translated/003_book_i_03_heaven_moves_spherically.md"
                if not failures
                else "",
                "final_allowed": False,
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.3 chapter control check passed; controlled translation prep is allowed")
    return 0
