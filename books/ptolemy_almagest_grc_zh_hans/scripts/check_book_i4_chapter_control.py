...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "004_book_i_04_chapter_control_check.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "004_book_i_04_chapter_control_check.md"


REQUIRED = [
    {
        "id": "control_exists",
        "path": "qa/chapter_controls/004_book_i_04_earth_is_spherical.control.md",
        "contains": [
    ...
    },
    {
        ...
        "path": "qa/pretranslation/004_book_i_04_formal_source_recheck.md",
        ...
        json.dumps(
            {
                ...
                "chapter": "Book I.4",
                "translation_file_allowed_next": "chapters/translated/004_book_i_04_earth_is_spherical.md"
                if not failures
                else "",
                "final_allowed": False,
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.4 chapter control check passed; controlled translation prep is allowed")
    return 0
