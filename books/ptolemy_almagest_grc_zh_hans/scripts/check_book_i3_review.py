...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "003_book_i_03_review_check.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "003_book_i_03_review_check.md"
...
REQUIRED = [
    {
        ...
        "contains": [
            ...
            "以太",
            "同质",
            "不允许写 `chapters/final/003_book_i_03_heaven_moves_spherically.md`",
        ],
    },
    {
        "id": "translation_check_exists",
        "path": "qa/pretranslation/003_book_i_03_translation_check.md",
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.3 review check passed; technical recheck remains pending")
    return 0
