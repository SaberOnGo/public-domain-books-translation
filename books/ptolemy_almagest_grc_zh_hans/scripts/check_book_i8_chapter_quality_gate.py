...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "008_book_i_08_chapter_quality_gate.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "008_book_i_08_chapter_quality_gate.md"
...
REQUIRED_MARKDOWN = [
    {
        ...
        "path": "qa/chapter_controls/008_book_i_08_two_primary_motions.quality_gate.md",
        "contains": [
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.8 chapter quality gate passed; final promotion remains pending")
    return 0
