...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "003_book_i_03_formal_source_recheck.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "003_book_i_03_formal_source_recheck.md"
...
REQUIRED = [
    ...
    },
    {
        ...
        "path": "qa/pretranslation/003_book_i_03_source_extraction_check.md",
        "contains": ["PASS_SOURCE_EXTRACTED__PDF_RECHECK_AND_TECHNICAL_QA_PENDING"],
    },
    {
        "id": "pdf_contact_sheet_exists",
        "path": "qa/technical/page_screenshots/book_i03_pages_009_011_contact_sheet.jpg",
        "contains": [],
    },
    {
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.3 formal source recheck passed; chapter control remains pending")
    return 0
