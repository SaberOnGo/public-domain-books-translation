...
OUT_JSON = PROJECT_ROOT / "qa" / "pretranslation" / "004_book_i_04_chapter_quality_gate.json"
OUT_MD = PROJECT_ROOT / "qa" / "pretranslation" / "004_book_i_04_chapter_quality_gate.md"
...
REQUIRED_MARKDOWN = [
    {
        ...
        "path": "qa/chapter_controls/004_book_i_04_earth_is_spherical.quality_gate.md",
        "contains": [
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("Book I.4 chapter quality gate passed; final promotion remains pending")
    return 0
