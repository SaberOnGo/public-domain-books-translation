# Book I.3 Source Extraction Check
...
| id | status | detail |
|---|---|---|
| source_file_exists | PASS | `chapters/src/003_book_i_03_heaven_moves_spherically.md` |
| source_control_wording | PASS | `[]` |
| marker_count_matches_segmentation | PASS | `109` |
| pdf_viewer_pages_recorded | PASS | `9-11` |
| translated_absent_or_allowed_by_control | PASS | `chapters/translated/003_book_i_03_heaven_moves_spherically.md` |
| final_absent | PASS | `chapters/final/003_book_i_03_heaven_moves_spherically.md` |
