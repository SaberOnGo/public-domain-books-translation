...
const cnOutFile = path.join(outputDir, '幽灵海盗.epub');
const titleMapPath = path.join(root, 'metadata', 'chapter_title_map.yaml');

const meta = {
  title: '幽灵海盗',
  subtitle: 'The Ghost Pirates',
  ...
  language: 'zh-CN',
  originalLanguage: 'en',
  identifier: 'pg10966-zh-cn-lifebook-v1',
...
<svg xmlns="http://www.w3.org/2000/svg" width="1600" height="2400" viewBox="0 0 1600 2400" role="img" aria-label="${esc(meta.title)}封面">
  <defs>
    <linearGradient id="sea" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0" stop-color="#08131a"/>
      <stop offset="0.55" stop-color="#12313a"/>
      <stop offset="1" stop-color="#0a0f13"/>
    </linearGradient>
    <linearGradient id="mist" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0" stop-color="#dfe9e7" stop-opacity="0.15"/>
      <stop offset="1" stop-color="#dfe9e7" stop-opacity="0.02"/>
    </linearGradient>
  </defs>
  <rect width="1600" height="2400" fill="url(#sea)"/>
  <rect x="120" y="140" width="1360" height="2120" rx="36" fill="#071116" stroke="#b8c7c3" stroke-width="4" opacity="0.94"/>
  <circle cx="1170" cy="430" r="118" fill="#d7ded6" opacity="0.82"/>
  <path d="M240 1510 C430 1410 650 1465 835 1370 C1040 1265 1230 1320 1475 1210 L1475 2260 L120 2260 L120 1690 C170 1628 205 1545 240 1510 Z" fill="#233d45"/>
  <path d="M180 1775 C370 1688 530 1725 710 1645 C900 1560 1110 1600 1460 1460 L1460 2260 L120 2260 L120 1905 C145 1850 160 1805 180 1775 Z" fill="#5d7579" opacity="0.62"/>
  <path d="M460 1275 L760 1385 L1130 1295 L1035 1450 L560 1460 Z" fill="#0b1115" stroke="#c5d0cd" stroke-width="7"/>
...
<package xmlns="http://www.idpf.org/2007/opf" unique-identifier="bookid" version="3.0" xml:lang="zh-CN">
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
    ...
    <dc:subject>海洋恐怖小说</dc:subject>
    <dc:subject>航海小说</dc:subject>
    <dc:subject>怪奇小说</dc:subject>
