...
参考 `books/pg20923_a_negro_explorer_at_the_north_pole` 的 EPUB 制作经验，以及 `template/epub_pipeline`、本书 `books/pg10966_the_ghost_pirates` 的规则，对《幽灵海盗》做二次出版级总审。不得只因 EPUBCheck 通过就结束；必须覆盖标题工程、章节精修、术语/译注统一、长段落处理、重要段落与高潮段落的文学性、“信达雅”与专业细节。
...
- `books/pg20923_a_negro_explorer_at_the_north_pole` 中标题工程、出版复核、EPUB 质量整改和精修 QA 记录
