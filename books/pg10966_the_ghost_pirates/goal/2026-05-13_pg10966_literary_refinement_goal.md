...
本文件定义 `books/pg10966_the_ghost_pirates/` 的后置精修 `/goal`。本轮目标参考 `books/pg20923_a_negro_explorer_at_the_north_pole/` 的处理经验：EPUBCheck 通过只是工程合格，不等于文本、目录、元数据和出版细节已经完成编辑级复查。
