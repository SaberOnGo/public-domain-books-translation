...
在既有 EPUB 完成版基础上，按 `template/epub_pipeline` 和本书 `books/pg10966_the_ghost_pirates` 的要求补做出版级查漏补缺，确认标题工程、章节精修、术语/译注统一、长段落处理、航海专业名词语境准确性均有证据闭环。
...
- `books/pg10966_the_ghost_pirates/AGENTS.md`
- `books/pg10966_the_ghost_pirates/SKILL.md`
- `books/pg10966_the_ghost_pirates/metadata/book_specific_translation_research.md`
- `books/pg10966_the_ghost_pirates/metadata/chapter_title_map.yaml`
- `books/pg10966_the_ghost_pirates/glossary/terms.csv`
