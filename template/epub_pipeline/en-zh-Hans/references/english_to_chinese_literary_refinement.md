...
- 普通名词、器物名、衣物名、材料名和动作名应译成中文，不得写成 `source term（中文释义）`，也不得写成 `中文词（source term）`。正文首次出现保留英文原名的规则只适用于音译人名；普通名词能准确翻译时，不应附加原文词。若确有不可译的民族语言词、历史词或技术词需要保留，应在术语表、译注或研究记录中说明，不要默认塞入正文。
