...
6. `references/ancient_greek_source_notes.md`
7. `references/ancient_greek_source_types.md`
8. `references/ancient_greek_textual_criticism_policy.md`
9. `references/ancient_greek_reference_translation_policy.md`
10. `references/ancient_greek_names_transliteration_policy.md`
...
1. `01_ingest_clean_zh_grc.md`
2. `02_split_zh_grc.md`
3. `03_global_translation_research_zh_grc.md`
4. `04_book_specific_research_zh_grc.md`
5. `05_pretranslation_trials_zh_grc.md`
6. `06_glossary_style_zh_grc.md`
7. `07_translate_chapters_zh_grc.md`
8. `08a_chapter_post_translation_control_zh_grc.md`
9. `08_review_fidelity_zh_grc.md`
10. `09_review_readability_imagery_zh_grc.md`
11. `10_review_terminology_zh_grc.md`
12. `11_chapter_quality_gate_zh_grc.md`
...
- 禁止为了简洁把中文压成动作清单。
- 禁止把现代编辑者目录、参考译本目录或扫描本目录式长标题链机械转换成中文破折号长链。
- 禁止封面、字体、metadata、版本说明等 EPUB 制作细节粗糙处理。
- 禁止把某一本书的精修目标放在仓库根目录；必须放在该书工程 `goal/` 下。
- 禁止发现可复用经验后只修当前书、不回填模板。
- 禁止从现代第二语言译本直接转译；翻译必须回到古希腊文底本。
- 禁止静默忽略异文、残损、OCR 不确定处或编辑者拟补。
- 禁止未建立 source witness 和 textual uncertainty 记录就批量翻译。
