...
- 古希腊文对照忠实度、漏译、误译、无依据增译，不得从第二语言参考译本直接转译。
- 中文可读性、成稿级润色、自然流畅度、证明/论述节奏和通俗顺读；译文应尽量读得顺、有趣、不费劲，但不得为了通俗化而损害专业术语、数学/天文学概念层级、证明链条或原书专业水准。
...
- 技术术语、证明依据、六十进制数值和章末注符合本书 style profile。
- 任何用户明确指出的问题已回写并修正。
