...
- 标题人名检查结果：章节标题/副标题/目录题名只使用中文译名或本书确定的中文呈现方式；标题中的人名不计入“正文首次出现”；韩文/朝鲜文原名、读音或括注只出现在正文第一次自然出现处、译注、术语表或书籍信息页。
- 韩语/朝鲜语底本文字形态检查结果：本章若涉及韩文/汉字混排、旧字、注记、OCR 疑难或异读，已和 `qa/textual/korean_textual_notes.md` 对齐。
...
- 不存在把韩文/朝鲜文原名、读音、罗马字或解释性括注塞进章节标题、副标题或目录题名的情况。
- 任何用户明确指出的问题已回写并修正。
