...
6. `references/korean_source_notes.md`
7. `references/korean_title_strategy.md`
...
1. `01_ingest_clean_zh_ko.md`
2. `02_split_zh_ko.md`
3. `03_global_translation_research_zh_ko.md`
4. `04_book_specific_research_zh_ko.md`
5. `05_pretranslation_trials_zh_ko.md`
6. `06_glossary_style_zh_ko.md`
7. `07_translate_chapters_zh_ko.md`
8. `08a_chapter_post_translation_control_zh_ko.md`
9. `08_review_fidelity_zh_ko.md`
10. `09_review_readability_imagery_zh_ko.md`
11. `10_review_terminology_zh_ko.md`
12. `11_chapter_quality_gate_zh_ko.md`
13. `13_preproduction_stage1_spec_zh_ko.md`
14. `14_preproduction_stage2_sample_zh_ko.md`
15. `15_full_book_production_zh_ko.md`
16. `prompts/16a_stratified_random_spotcheck.md`
17. `16_independent_review_agents_zh_ko.md`
18. `17_revision_routing_zh_ko.md`
19. `prompts/18a_release_versioning.md`
20. `18_final_output_zh_ko.md`
21. `19_retrospective_template_update_zh_ko.md`
...
- 禁止为了简洁把中文压成动作清单。
- 禁止把韩文/朝鲜文原题、读音、罗马字或解释性括注塞进 EPUB 目录题名。
- 禁止把韩语/朝鲜语汉字词未经判断直接照搬成现代中文。
