...
- 这一段中文是否能自然读懂。
- 是否忠实于日语公版原文，不借现代中文译本或其他译本改写。
- 日语修饰链、省略、敬语、称谓、人物关系、历史语境、动作强度和叙述立场是否被正确转成自然中文。
...
- 任一样本出现读者读不懂、事实或叙述关系误解、日语句法硬搬、无依据润饰、术语/专名/译注/表格/图片/公式错误，必须判为失败，即使平均分达标。
