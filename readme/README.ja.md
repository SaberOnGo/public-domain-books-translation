...
原言語が英語、対象言語が簡体字中国語の場合は、対象言語のみの EPUB と英中対照 EPUB の両方を既定で出力してください。他の言語ペアで対照版も必要な場合は、prompt に `请输出 edition_type: bilingual_parallel，同时生成目标语言版 EPUB 和源语言-目标语言双语对照版 EPUB。` を追加してください。
